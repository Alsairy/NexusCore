...
public class NexusCoreDomainSharedModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        NexusCoreGlobalFeatureConfigurator.Configure();
        NexusCoreModuleExtensionConfigurator.Configure();
    }
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.FileSets.AddEmbedded<NexusCoreDomainSharedModule>();
        });

        Configure<AbpLocalizationOptions>(options =>
        {
            options.Resources
                .Add<NexusCoreResource>("en")
                .AddBaseTypes(typeof(AbpValidationResource))
                .AddVirtualJson("/Localization/NexusCore");

            options.DefaultResourceType = typeof(NexusCoreResource);
        ...
        {
            options.MapCodeNamespace("NexusCore", typeof(NexusCoreResource));
        });
    }
}
