...
namespace NexusCore.Migrations
{
    ...
    [Migration("20260207165459_AddSaudiKit")]
    partial class AddSaudiKit
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NexusCore.Saudi.Nafath.NafathAuthRequest", b =>
                {
                    b.Property<Guid>("Id")
                    ...
                    b.ToTable("Saudi_NafathAuthRequests", (string)null);
                });

            modelBuilder.Entity("NexusCore.Saudi.Nafath.NafathUserLink", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("Saudi_NafathUserLinks", (string)null);
                });

            modelBuilder.Entity("NexusCore.Saudi.Workflows.ApprovalDelegation", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("Saudi_ApprovalDelegations", (string)null);
                });

            modelBuilder.Entity("NexusCore.Saudi.Workflows.ApprovalTask", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");

                    b.Property<string>("AssignedToRoleName")
                        .HasMaxLength(256)
                    ...
                    b.ToTable("Saudi_ApprovalTasks", (string)null);
                });

            modelBuilder.Entity("NexusCore.Saudi.Zatca.ZatcaCertificate", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("TenantId", "SellerId", "IsActive");

                    b.ToTable("Saudi_ZatcaCertificates", (string)null);
                });

            modelBuilder.Entity("NexusCore.Saudi.Zatca.ZatcaInvoice", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("ZatcaRequestId")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.ToTable("Saudi_ZatcaInvoices", (string)null);
                });

            modelBuilder.Entity("NexusCore.Saudi.Zatca.ZatcaInvoiceLine", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("Saudi_ZatcaInvoiceLines", (string)null);
                });

            modelBuilder.Entity("NexusCore.Saudi.Zatca.ZatcaSeller", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("TenantId", "VatRegistrationNumber");

                    b.ToTable("Saudi_ZatcaSellers", (string)null);
                });
            ...
            modelBuilder.Entity("NexusCore.Saudi.Zatca.ZatcaCertificate", b =>
                {
                    b.HasOne("NexusCore.Saudi.Zatca.ZatcaSeller", "Seller")
                        .WithMany()
            ...
            modelBuilder.Entity("NexusCore.Saudi.Zatca.ZatcaInvoiceLine", b =>
                {
                    b.HasOne("NexusCore.Saudi.Zatca.ZatcaInvoice", null)
                        .WithMany("Lines")
